...
function NewBlog() {
  ...
  const containerRef = useClickOutside(()=>{
    if(editMode){
      dispatch(modalActions.toggleWarningModal());
      return;
    } 
    setShowModal(false);
    setTimeout(()=>{
        ...
        <div className={containerStyles} ref={containerRef}>
            ...
            <div className={styles.blog_details}>
              ...
              <div className={styles.blog_details_wrapper}>
                <Input type='text' placeholder={APP_MESSAGES.BLOG.BLOG_DETAILS_PLACEHOLDER} onChange={onBlogDetailsChange} value={blogDetails} blogDetail/>
              </div>
